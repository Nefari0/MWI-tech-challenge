    ...
    <div className="App">
      ...
      <header className="home-header" >
        ...
        {isContact === false ? <div className='heading-2-text'><h1 className="heading-1" >Heading One</h1>
          ...
          {/* <div className='mobile-contact-display' ><Contact /></div> */}
          {isContact === false ? <Contact /> : null}
        </div>

        <div className='mobile-header-right'>
          {isContact === true ? <a onClick={() => setIsContact(!isContact)}>contact</a> : <a onClick={() => setIsContact(!isContact)}>home</a>}
        </div>
